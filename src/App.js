    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background: `
            radial-gradient(circle at ${mousePosition.x}% ${mousePosition.y}%, rgba(0, 112, 243, 0.04) 0%, transparent 40%),
            radial-gradient(circle at ${100 - mousePosition.x}% ${100 - mousePosition.y}%, rgba(124, 58, 237, 0.03) 0%, transparent 40%),
            var(--bg-primary)
          `
        }}
      />
