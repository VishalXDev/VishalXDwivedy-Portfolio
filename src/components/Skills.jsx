  ...
  const skillCategories = useMemo(() => [
    {
      ...
      skills: ['React.js', 'Next.js', 'JavaScript (ES6+)', 'HTML5', 'CSS3', 'Tailwind CSS'],
      specialIcons: {
        'React.js': FaReact, 
    ...
    },
    {
      ...
      skills: ['Node.js', 'Express.js', 'REST APIs', 'GraphQL', 'WebSockets', 'MongoDB', 'Firebase'],
      specialIcons: {
        'Node.js': FaNodeJs, 
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto leading-relaxed">
            Focused on building AI-powered systems, scalable applications, and reliable production experiences
          </p>
        </motion.div>
