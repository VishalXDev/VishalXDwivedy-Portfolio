            ...
            <div className="glass-card p-6 lg:p-8 group hover:glass-card-hover transition-all duration-300">
              <div className="relative">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["Frontend Systems", "AI & LLM", "APIs", "Testing & Reliability"].map((tag) => (
                    <span
                      key={tag}
                ...
                <p className="text-sm sm:text-base text-muted leading-relaxed">
                  Software Engineer building AI-powered web apps and real-time systems. 
                  Focused on frontend, APIs, and LLM features with strong emphasis on 
                  testing, debugging, and production reliability.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card p-6 lg:p-8 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-sm sm:text-base text-muted leading-relaxed">
                  Software Engineer experienced in building AI-driven applications and 
                  real-time systems using React, Node.js, and modern APIs. 
                  <br /><br />
                  I work across development and testing — improving system reliability, 
                  handling edge cases, and delivering scalable, production-ready experiences.
                </p>
              </div>
            </div>
