...
const Education = () => {
  ...
  return (
    <section id="education" className="relative min-h-screen pt-20 pb-20 bg-gray-900 text-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          {educationData.map((item, index) => (
            ...
            >
              <div className={`relative bg-gradient-to-br ${item.gradient} backdrop-blur-sm border border-white/10 rounded-2xl p-8 overflow-hidden transition-all duration-300 hover:border-white/20`}>
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h4 className={`font-bold text-lg mb-1 ${cert.color}`}>
                      {cert.title}
                    </h4>
