...
const Education = () => {
  const educationData = [
    {
      ...
      points: [
        ...
        "Worked on collaborative and practical development tasks"
      ],
    ...
    },
    {
      ...
      icon: "🧠",
      status: "Completed",
      note: "Psychology background supports user-focused design, UX thinking, and understanding of user behavior.",
      highlight: "User-Centric Thinking & UX Perspective",
  ...
  const certifications = [
    ...
    },
    {
      ...
      subtitle: "Data Analysis & Fundamentals",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-muted max-w-2xl mx-auto text-lg">
            Combining technical expertise with psychological insights for
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 mb-20">
          {educationData.map((item, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${item.gradient} opacity-50`}
              />
              ...
              <div className="relative p-6 lg:p-8 flex flex-col h-full">
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div
                    className={`px-3 py-1.5 rounded-full text-sm font-medium border ${statusStyles[item.statusColor].bg} ${statusStyles[item.statusColor].text} ${statusStyles[item.statusColor].border}`}
                  >
                    {item.status}
                  </div>
                </div>
              ...
              >
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4
                      className={`text-lg lg:text-xl font-bold mb-1 bg-gradient-to-r ${cert.gradient} bg-clip-text text-transparent`}
                    >
                      {cert.title}
                    </h4>
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${cert.gradient.replace("from-", "from-").replace("to-", "to-")}/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                />
              </motion.div>
            ))}
          </div>
          ...
          <div className="mt-12 text-center">
            <div className="glass-card p-6 inline-block">
              <p className="text-muted text-sm">
                🚀 Continuously learning and expanding knowledge in emerging
                technologies
              </p>
            </div>
          </div>
