...
const Hero = () => {
  ...
  const introduction =
    "Hi, I'm Vishal Dwivedy, a Software Engineer at 169Pi, working on AI-powered web applications, real-time systems, and reliable production systems with strong focus on frontend, APIs, and testing.";
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-16">
          ...
          >
                    ...
                    >
                      <TypewriterText
                        texts={[
                          ...
                          "Frontend • APIs • Testing & Reliability",
                        ]}
                        speed={50}
                        deleteSpeed={30}
                        delayBetween={2000}
            ...
            <m.p
              ...
              className="text-sm sm:text-base lg:text-lg text-muted leading-relaxed max-w-xl"
            >
              Building AI-powered web apps and real-time systems. Focused on
              frontend, APIs, and LLM features — with strong emphasis on
              testing, debugging, and reliable, production-ready experiences.
            </m.p>
            ...
            >
              {/* Primary CTA */}
              <button
                onClick={() => document.dispatchEvent(new CustomEvent('navigate', { detail: 'projects' }))}
              ...
              {/* Secondary CTA */}
              <a
                href="https://drive.google.com/file/d/16aLyHR1DrB-CDlz4OOn2oeeWdgEglk5H/view?usp=sharing"
                target="_blank"
            ...
            >
              {socialLinks.map(
                ({ icon: Icon, href, label, gradient }, index) => (
                  <a
                    key={index}
                    href={href}
                    target="_blank"
