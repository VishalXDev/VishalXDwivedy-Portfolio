      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto leading-relaxed">
            ...
            <br /><br />
            Open to impactful opportunities, collaborations, and challenging engineering problems.
          </p>
        </motion.div>
            ...
            <div className="glass-card p-8 lg:p-10 border border-[var(--border-color)] rounded-3xl bg-[var(--surface-primary)]/50 backdrop-blur-xl">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-[var(--text-secondary)] text-sm">Typically respond within 24 hours</p>
                </div>
              </div>
              ...
              <AnimatePresence mode="wait">
                {formStatus.isSubmitted ? (
                  ...
                  >
                    ...
                    <h4 className="text-2xl font-bold text-[var(--text-primary)] mb-3">Message Sent 🚀</h4>
                    <p className="text-[var(--text-secondary)] mb-6">Appreciate you reaching out — I'll get back to you shortly.</p>
                    <motion.button
                      onClick={resetForm}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <span className="text-green-400 text-sm font-medium">Actively open to opportunities</span>
                  </div>
                </div>
              </div>
            </div>
